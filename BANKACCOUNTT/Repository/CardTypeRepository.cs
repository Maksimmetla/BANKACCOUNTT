...
namespace BANKACCOUNTT.Repository
{
    public class CardTypeRepository : ICardTypeRepository
    {
        ...
        public CardTypeRepository(BankaccounttContext context)
        {
            _context = context;
        }
        ...
        {
            var deletedEntry = await _context.CardTypes.FirstOrDefaultAsync(c =>
           c.Id == id);
        ...
        {
            var ExitingCardType = await _context.CardTypes.FirstOrDefaultAsync(c =>
           c.Id == id);
